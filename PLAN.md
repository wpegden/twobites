...
- Dependency order:
  ...
  6. Closed-pair counting layer:
    ...
    - the next concrete subgoal is the semantic bridge from `section4RevealPairSet` to the paper’s “open pairs destroyed / unrevealed open pairs remain” statement, and then packaging the remaining unrevealed pairs in the form needed for the eventual `lem:RISI` proof
  7. Section 4 layer:

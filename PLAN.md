...
- Dependency order:
  ...
  6. Closed-pair counting layer:
     ...
     - the remaining arithmetic target is to prove those stronger branch-deficit inequalities for the explicit parameter `paperHugeWitnessBranchParam`, then feed the resulting exact-route theorem into the final paper-facing wrappers
  7. Section 4 layer:

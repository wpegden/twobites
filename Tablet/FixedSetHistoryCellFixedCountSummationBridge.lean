import Tablet.FixedSetHistoryCellFixedCountBlueWeightSum
import Tablet.FixedSetHistoryCellFixedCountRedWeightSum

-- [TABLET NODE: FixedSetHistoryCellFixedCountSummationBridge]

theorem FixedSetHistoryCellFixedCountSummationBridge :
...
-- BODY
  ...
  · intro horder
    simpa only using
      @FixedSetHistoryCellFixedCountRedWeightSum
          ...
          hblue_before_red hterminal_not_recorded hstaged_terminal hproductLaw hprefix_safe
          hopen_lower hbranch_pkg horder
  · intro horder
    simpa only using
      @FixedSetHistoryCellFixedCountBlueWeightSum
          n m k ℓR ℓB p ε ε1 ε2
          I hist recorded terminal redOrder rep uR uB
          _hEdgeDec _hRedDec _hBlueDec
          hε1_nonneg hε1_le_one hp_nonneg hp_le_half hI_card hhist_rep
          hprojSize hhist_desc hrecorded hterminal hredOrder_nodup hredOrder_finset
          hred_before_blue hterminal_not_recorded hstaged_terminal hproductLaw hred_prefix_safe
          hopen_lower hbranch_pkg horder

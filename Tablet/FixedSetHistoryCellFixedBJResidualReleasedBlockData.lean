...
-- [TABLET NODE: FixedSetHistoryCellFixedBJResidualReleasedBlockData]

theorem FixedSetHistoryCellFixedBJResidualReleasedBlockData :
    ∀ {n m uR uB : ℕ} {p ε a : ℝ}
      (I : Finset (Fin n))
...
-- BODY
  ...
  intro n m uR uB p ε a I hist target recorded terminal order B BranchLabel
    _ blueTrace transcriptLabels RedLabel _ J redSupport cellEvent

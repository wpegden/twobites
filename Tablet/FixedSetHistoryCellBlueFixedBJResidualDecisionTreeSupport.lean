...
-- [TABLET NODE: FixedSetHistoryCellBlueFixedBJResidualDecisionTreeSupport]

theorem FixedSetHistoryCellBlueFixedBJResidualDecisionTreeSupport :
    ∀ {n m uR uB : ℕ} {p a : ℝ}
...
-- BODY
  classical
  intro n m uR uB p a hist terminal order B BranchLabel _ redTrace
    transcriptLabels BlueLabel _ J blueSupport cellRealized
    ...
    hproduct_law hBcard hBterm hBblue hredTrace_functional
  ...
  have hreleased_sum :
      (Finset.univ : Finset BranchLabel).sum
        ...
        ≤ 1 :=
    FixedSetHistoryCellBlueReleasedCylinderPacking
